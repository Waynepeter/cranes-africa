...
function PrivacyPolicy({ organizationData }) {
  ...
  return (<>
    ...
    <header
      ...
      <div className="container">
        <h2 className="section-intro__subtitle">Privacy policy</h2>
        <div className="btn-group breadcrumb">
          <a href="/" className="btn">Home</a><span className="btn btn--rightBorder">Privacy policy</span>
        </div>
      </div>
    </header>
    ...
    <section className="sample-text-area">
      ...
      : organizationData.organization.privacy ? parseHTML(organizationData.organization.privacy)
