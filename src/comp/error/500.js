    ...
    <>
      ...
      <header
        ...
        <div className="container">
          <h2 className="section-intro__subtitle">Error 500</h2>
          <div className="btn-group breadcrumb">
            <a href="/" className="btn">Home</a><span className="btn btn--rightBorder">Error 500</span>
          </div>
        </div>
      </header>
      ...
      <section className="sample-text-area">
        <div className="container">
          <h3 className="text-heading">500 Internal Server Error</h3>
