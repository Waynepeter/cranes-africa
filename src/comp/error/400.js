    ...
    <>
      ...
      <header
        ...
        <div className="container">
          <h2 className="section-intro__subtitle">Error 400</h2>
          <div className="btn-group breadcrumb">
            <a href="/" className="btn">Home</a><span className="btn btn--rightBorder">Error 400</span>
          </div>
        </div>
      </header>
      ...
      <section className="sample-text-area">
        <div className="container">
          <h3 className="text-heading">400 Bad Request</h3>
