  ...
  return (<>
    ...
    <header
      ...
      <div className="container">
        <h2 className="section-intro__subtitle">Portfolio</h2>
        <div className="btn-group breadcrumb">
          <a href="/" className="btn">Home</a><span className="btn btn--rightBorder">Portfolio</span>
        </div>
      </div>
    </header>
    ...
    : organizationData.organization.projects ?
      <section className="sample-text-area">
        <div className="container">
        { index.substring(1) ? <>
          <h2>{organizationData.organization.projects[index.substring(1)].name}</h2>
          {parseHTML(organizationData.organization.projects[index.substring(1)].description)}
          </>
