...
function Confidentiality({ organizationData }) {
  ...
  return (<>
    ...
    <header
      ...
      <div className="container">
        <h2 className="section-intro__subtitle">Trust &amp; Confidentiality</h2>
        <div className="btn-group breadcrumb">
          <a href="/" className="btn">Home</a><span className="btn btn--rightBorder">Confidentiality</span>
        </div>
      </div>
    </header>
    ...
    <section className="sample-text-area">
      ...
      : organizationData.organization.confidentiality ? parseHTML(organizationData.organization.confidentiality)
...
export default connect(mapStateToProps, mapDispatchToProps)(Confidentiality);